...
<main class="about-section" style="background: #f5f8fc;">
    ...
    <section class="about-story-legacy" style="margin-bottom:3.2rem; width:99%; margin:0 auto;">
        ...
        <section class="about-vmv-section" style="margin: 3.5rem 0 2.5rem 0; max-width:1600px; width:90%; margin-left:auto; margin-right:auto;">
            <div class="about-vmv-row" style="display:flex; gap:2rem; justify-content:center; margin-bottom:2rem; width:99%; margin:0 auto;">
                <!-- Vision Column -->
...
<span class="about-vmv-title" style="font-size:1.1rem; color:#1a4fa0;">Mission</span>
            ...
            <div class="about-vmv-row" style="display:flex; justify-content:center; width:99%; margin:0 auto;">
...
<span class="about-vmv-title" style="font-size:1.3rem; color:#1a4fa0; font-weight:700; letter-spacing:0.01em;">Core Values</span>
                    ...
                    <div class="core-values-list" style="display:grid; grid-template-columns:repeat(auto-fit,minmax(320px,1fr)); gap:2rem; font-size:1.15rem; line-height:1.7; padding:0; margin:0;">
                        <div style="background:#f7faff; border-radius:1rem; padding:1.2rem; box-shadow:0 1px 4px rgba(0,0,0,0.03);">
                            <strong style="color:#0077b6;">Community Impact:</strong> <span style="color:#222;">Enriching lives through accessible, beautiful, and purposeful projects that benefit communities for generations.</span>
                        </div>
                        <div style="background:#f7faff; border-radius:1rem; padding:1.2rem; box-shadow:0 1px 4px rgba(0,0,0,0.03);">
                            <strong style="color:#0077b6;">Continuous Improvement:</strong> <span style="color:#222;">Fostering a culture of learning, growth, and innovation by embracing new technologies and encouraging skill development.</span>
                        </div>
                        <div style="background:#f7faff; border-radius:1rem; padding:1.2rem; box-shadow:0 1px 4px rgba(0,0,0,0.03);">
                            <strong style="color:#0077b6;">Commitment to Excellence:</strong> <span style="color:#222;">Upholding the highest standards in safety, quality, integrity, and project management, with a relentless pursuit of perfection.</span>
                        </div>
                        <div style="background:#f7faff; border-radius:1rem; padding:1.2rem; box-shadow:0 1px 4px rgba(0,0,0,0.03);">
                            <strong style="color:#0077b6;">Empowering People:</strong> <span style="color:#222;">Recognizing people as our greatest asset, nurturing talent, fostering diversity, and empowering every team member to lead and innovate.</span>
                        </div>
                        <div style="background:#f7faff; border-radius:1rem; padding:1.2rem; box-shadow:0 1px 4px rgba(0,0,0,0.03);">
                            <strong style="color:#0077b6;">Collaboration:</strong> <span style="color:#222;">Building strong, cooperative relationships with clients, partners, and communities to achieve shared success and lasting impact.</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="display:flex; flex-wrap:wrap; gap:2rem; justify-content:center; margin-top:1.5rem; width:99%; margin:0 auto;">
                ...
                $whyChoose = [
                    [
                        ...
                        'desc' => 'Recognized for excellence and reliability in the Ghanaian construction industry.'
                    ],
                    [
                        'icon' => 'fa-hand-holding-usd',
                        'title' => 'Flexible Financing',
                        'desc' => 'We make your project affordable and accessible with flexible payment options.'
                    ],
                    [
                        'icon' => 'fa-comments',
                        'title' => 'Free Consultations',
                        'desc' => 'Get expert advice and a personalized quote at no cost, at your location or online.'
                    ],
                    [
                        'icon' => 'fa-users',
                        'title' => 'Trusted by Leading Businesses',
                        'desc' => 'We are the partner of choice for top companies and organizations in Ghana.'
                    ]
                ];
...
<h3 class="about-section-title" style="font-family:'Playfair Display',serif; font-weight:800; font-size:1.1rem; color:#1a4fa0; text-align:center; margin-bottom:1.2rem;"><i class="fas fa-quote-left" style="color:#1a4fa0;"></i> What Our Clients Say</h3>
            <div class="about-testimonials-row" style="display:flex; flex-wrap:wrap; gap:2rem; justify-content:center; margin-top:1.5rem;">
                ...
                $testimonials = [
                    [
                        'quote' => '“DnR Engineering Construction built my dream home and exceeded my expectations in every way possible. They were professional, reliable, and completed the project within the agreed timeline. I highly recommend them for any construction project.”',
                        'client' => '— Kwame Amankwah'
                    ],
                    [
                        'quote' => '“I hired DnR for a commercial project and was impressed with their attention to detail and quality workmanship. They worked within my budget and delivered the project on time. I will definitely hire them again for future projects.”',
                        'client' => '— Grace Mensah'
                    ],
                    [
                        'quote' => '“DnR transformed my old family home into a modern and functional home that I love spending time in. Their team was professional and friendly, and they kept me informed throughout the entire process. I highly recommend them for any remodelling project.”',
                        'client' => '— Kofi Adu'
                    ]
                ];
                foreach ($testimonials as $t): ?>
                <div class="about-testimonial-card" style="background:#fff; border-radius:1rem; box-shadow:0 4px 24px rgba(26,79,160,0.08); padding:1.5rem 1.2rem; max-width:340px; min-width:220px; flex:1 1 220px; display:flex; flex-direction:column; align-items:center;">
                    <div class="about-testimonial-quote" style="font-style:italic; color:#1a4fa0; margin-bottom:1rem;"><?= $t['quote'] ?></div>
                    <div class="about-testimonial-client" style="font-weight:600; color:#222;"><?= $t['client'] ?></div>
                </div>
                <?php endforeach; ?>
            </div>
            <div style="margin-top:2.5rem;">
                <a href="mailto:info@dnrengineering.com?subject=Free%20Consultation%20Request" style="display:inline-block; background:#1a4fa0; color:#fff; font-weight:600; padding:1rem 2.2rem; border-radius:2rem; font-size:1.15rem; box-shadow:0 2px 12px rgba(26,79,160,0.10); text-decoration:none; transition:background 0.2s;">Get a Free Consultation</a>
            </div>
        </div>
    </section>
</main>
